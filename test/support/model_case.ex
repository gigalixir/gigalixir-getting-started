defmodule GigalixirGettingStarted.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import GigalixirGettingStarted.ModelCase
    end
  end
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&GigalixirGettingStarted.ErrorHelpers.translate_error/1)
