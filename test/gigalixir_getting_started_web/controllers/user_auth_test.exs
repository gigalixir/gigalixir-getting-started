defmodule GigalixirGettingStartedWeb.UserAuthTest do
  use GigalixirGettingStartedWeb.ConnCase, async: true

  alias GigalixirGettingStarted.Accounts
  alias GigalixirGettingStartedWeb.UserAuth
  import GigalixirGettingStarted.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, GigalixirGettingStartedWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
