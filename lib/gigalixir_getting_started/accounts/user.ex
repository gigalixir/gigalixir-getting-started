defmodule GigalixirGettingStarted.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, GigalixirGettingStarted.Repo)
  ...
  """
  def valid_password?(%GigalixirGettingStarted.Accounts.User{hashed_password: hashed_password}, password)
